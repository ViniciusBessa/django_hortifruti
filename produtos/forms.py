...
class FinalizarPedido(forms.Form):
    transportadoras = [[transportadora, transportadora.titulo] for transportadora in Transportadora.objects.all()]
    formas_pagamento = [[forma_pagamento, forma_pagamento.titulo] for forma_pagamento in FormaPagamento.objects.all()]
